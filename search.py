...
def get_top_ten_sites(user_query):
	...
	for query_number, relevant_urls in top_matched_urls.items():
		...
		top_ten_urls_with_score = sorted(sorted_top_urls[-10:])
		# top_ten_urls_with_score = sorted_top_urls[-10:]
